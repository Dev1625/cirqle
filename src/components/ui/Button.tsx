    ...
    return (
      <button
        ...
        className={cn(
          ...
          "inline-flex items-center justify-center whitespace-nowrap rounded-card font-mono text-[10px] uppercase font-bold tracking-widest transition-[color,background-color,transform] duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand focus-visible:ring-offset-2 focus-visible:ring-offset-paper disabled:pointer-events-none disabled:cursor-not-allowed",
          {
            ...
            "bg-brand text-brand-on hover:bg-[#8E2A3A] active:bg-[#661D29] active:scale-[0.98] disabled:bg-brand disabled:text-brand-on/70": variant === "brand",
